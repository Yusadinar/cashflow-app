...
<head>
    ...
    <title>Sign Up — CashFlow Manager</title>
...
<body class="font-sans antialiased min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <p class="text-sm text-slate-500 text-center mb-7">Sign up to manage your finances</p>
            ...
            <form method="POST" action="<?= url('auth/register.php') ?>" class="space-y-5">
                <div>
            ...
            <p class="text-center text-sm text-slate-500 mt-6">
                Already have an account? <a href="<?= url('auth/login.php') ?>" class="text-brand-600 font-semibold hover:underline">Sign in</a>
            </p>
        </div>
    </div>
