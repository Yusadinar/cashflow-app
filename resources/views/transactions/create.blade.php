<x-app-layout>
    <x-slot name="header">
        <h1 class="font-bold text-slate-800 text-xl">Add Transaction</h1>
        <p class="text-sm text-slate-500 mt-1">Record a new income or expense</p>
    </x-slot>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="payment_method_id" name="payment_method_id" required
                                        class="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition-all shadow-sm">
                                    <option value="" disabled {{ old('payment_method_id') ? '' : 'selected' }}>Select payment method...</option>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea id="description" name="description" rows="3"
                                          ...
                                          class="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition-all shadow-sm">{{ old('description') }}</textarea>
                            </div>
